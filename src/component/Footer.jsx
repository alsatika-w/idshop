        ...
        <div className="grid grid-cols-1 md:grid-row gap-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <img src={Bca} alt="BCA" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Mandiri} alt="Mandiri" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Bri} alt="BRI" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Bni} alt="BNI" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={gopay} alt="Gopay" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Dana} alt="Dana" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Alfamart} alt="Alfamart" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Visa} alt="Visa" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={MasterCard} alt="MasterCard" className="h-8 md:h-10 bg-white px-2 rounded-md" />
            </div>
          </div>
          {/* Shipping Services */}
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <img src={Jne} alt="JNE" className="h-8 md:h-10  bg-white px-2 rounded-md" />
              <img src={Sicepat} alt="Sicepat" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Jnt} alt="J&T Express" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Gosend} alt="Gosend" className="h-8 md:h-10 bg-white px-2 rounded-md" />
              <img src={Grab} alt="Grab Express" className="h-8 md:h-10 bg-white px-2 rounded-md" />
            </div>
          </div>
